...
filePath = 'WSD/Data/1-dev-set.json' #'WSD/Data/Test.json' #'./ArabGlossBERT/examples.json'
glossesDict=  "WSD/Data/3-dev-sense-dictionary.json" #"./ArabGlossBERT/dictionary.json"
glossesDictContent = {}
