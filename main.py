...
filePath = 'WSD/Data/dev-set.json' #'WSD/Data/Test.json' #'./ArabGlossBERT/examples.json'
glossesDict=  'WSD/Data/senses-dictionary.json'#"WSD/Data/dictionary.json" #"./ArabGlossBERT/dictionary.json"
glossesDictContent = {}
